...
> [`dockone.io/article/1066`](http://dockone.io/article/1066)

【编者的话】这篇博客是用微服务建应用的第六篇，[第一篇](http://dockone.io/article/394)介绍了微服务架构模板，并且讨论了使用微服务的优缺点。随后的文章讨论了微服务不同方面：使用 API 网关，进程间通讯，服务发现和事件驱动数据管理。这篇文章，我们将讨论部署微服务的策略。
...
下图展示的是这种架构：
![1.png](img/d3d15ba81271deaa7cc5fe582066feba.jpg)
...
![2.png](img/6e4a8a5e4f8e34d83e2e2a1c7431b65b.jpg)
...
下图展示了这种模式：
![3.png](img/50c598aa1023657b69186e1a9b8815b7.jpg)
...
1.  直接方式，使用 web 服务请求
2.  自动方式，回应例如 AWS S3，DynamoDB，Kinesis 或者 Simple Email Service 等产生的事件
3.  自动方式，通过 AWS API 网关来处理应用客户端发出的 HTTP 请求​
4.  定时方式，通过 cron 响应​--很像定时器方式
