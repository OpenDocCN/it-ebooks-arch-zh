...
> [`dockone.io/article/936`](http://dockone.io/article/936)
...
![1.png](img/3889e1909cf4b5f75df6c42e4ed43fc1.jpg)
...
1.  订单服务创建一个带有 NEW 状态的 Order （订单），发布了一个“Order Created Event（创建订单）”的事件。
    ![2.png](img/7508607b16a053d9a701b7f501722b3a.jpg)
2.  客户服务消费 Order Created Event 事件，为此订单预留信用，发布“Credit Reserved Event（信用预留）”事件
    ![3.png](img/314f1044e032101c2ae5b8cc09097094.jpg)
3.  订单服务消费 Credit Reserved Event，改变订单的状态为 OPEN
    ![4.png](img/2e3043288a994f32ee781df76dfa9447.jpg)
...
![5.png](img/11fc8e193535a26fe7b3431a0b6626ab.jpg)
...
![6.png](img/35016a7b1152e9a3adae44861d153817.jpg)
...
![7.png](img/3c0d406d169fb48d5840da8206f79b1a.jpg)
...
![8.png](img/fb7cd52394c74465e9977e889bca063b.jpg)
...
*   Introduction to Microservices: [`dockone.io/article/394`](http://dockone.io/article/394)
*   Building Microservices: Using an API Gateway: [`dockone.io/article/482`](http://dockone.io/article/482)
*   Building Microservices: Inter-Process Communication in a Microservices Architecture: [`dockone.io/article/549`](http://dockone.io/article/549)
*   Service Discovery in a Microservices Architecture: [`dockone.io/article/771`](http://dockone.io/article/771)
