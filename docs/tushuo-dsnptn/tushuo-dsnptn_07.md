...
![../_images/Singleton.jpg](img/Singleton.jpg)

## 5.4\. 时序图

![../_images/seq_Singleton.jpg](img/seq_Singleton.jpg)
...
{
 Singleton * sg = Singleton::getInstance();  sg->singletonOperation(); 	
	return 0;
} 
```
...
![../_images/Singleton_run.jpg](img/Singleton_run.jpg)
...
*   单例模式适用情况包括：系统只需要一个实例对象；客户调用类的单个实例只允许使用一个公共访问点。 © 版权所有 2014, Colin http://blog.me115.com. 由 [Sphinx](http://sphinx-doc.org/) 1.3.5 创建。